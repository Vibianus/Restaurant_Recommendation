                ...
                if messaging_event.get("message"):  # someone sent us a message
                    ...
                    if "text" in messaging_event["message"] :
                        ...
                        if type(reply) == str :
                            ...
                            loc = global_stat['location']
                            tim = global_stat['time']
                            rec_reply = "推薦您" + str(loc) + str(tim) + "的餐廳"
...
def check_stat_and_recommend(message_text, stat_result, recipient_id):
    ...
    if stat_result['result']['location'] == '' and stat_result['result']['time'] == '' :
        ...
        global_stat['time'] = stat_result['result']['time'].encode('UTF-8')
        global_stat['location'] = stat_result['result']['location'].encode('UTF-8')
